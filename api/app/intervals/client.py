...
def fetch_activities_detailed(
    *,
    ...
    Same endpoint and request shape as ``fetch_activity_calories_by_day``, but
...
def fetch_planned_events(
    *,
    ...
    Same auth/timeout/retry shape as ``fetch_activity_calories_by_day``, but
...
def _get_json_with_retries(
    *,
    ...
    """Perform a GET with the same bounded-retry/auth/timeout shape as
    ``fetch_activity_calories_by_day``, returning the parsed JSON body.
